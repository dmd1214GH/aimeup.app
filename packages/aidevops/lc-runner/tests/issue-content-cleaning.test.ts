...
- Identifier: AM-57`;
      ...
      expect(title).toBe('LCR2: Convert operation-report creation and upload to a Claude Code Subagent');
    });
...
* Do something`;
      ...
      // Extract body
      const bodyLines = metadataIndex !== -1 
        ? lines.slice(1, metadataIndex)
        : lines.slice(1);
