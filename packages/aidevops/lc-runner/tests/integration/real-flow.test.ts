...
describe('lc-runner Integration Tests', () => {
  ...
  test('REAL TEST: Full operation creates expected file structure', () => {
  ...
  test('REAL TEST: Upload-only with actual file validation', () => {
...
This is a real comment
    ...
    expect(result.updatedIssue).toContain('Real content from Claude');
  });
});